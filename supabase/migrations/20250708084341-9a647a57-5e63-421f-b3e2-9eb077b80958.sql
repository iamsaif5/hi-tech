-- Phase 1: Create comprehensive sample data for all entities and statuses
...
-- Update some orders to have been converted from quotes
UPDATE orders SET quote_id = (SELECT id FROM quotes WHERE product = 'Lion 10kg White Bags' AND status = 'Accepted' LIMIT 1) 
WHERE product = 'Lion 10kg White Bags' AND delivery_date = '2025-01-15';
